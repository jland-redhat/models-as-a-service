...
#   OPERATOR_STARTING_CSV - Subscription startingCSV (default: opendatahub-operator.v3.3.0). Set to "-" to omit and follow channel head.
...
# Default pin: ODH 3.3.0. Override OPERATOR_STARTING_CSV, or set "-" to omit startingCSV (channel head).
starting_csv="${OPERATOR_STARTING_CSV:-opendatahub-operator.v3.3.0}"
