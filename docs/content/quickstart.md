...
=== "Operator (Recommended)"
    ...
    ```bash
    export MAAS_REF="v3.0.1"  # Use the latest release tag, or "main" for development
    ...
    !!! note "Using Release Tags"
        ...
        The release workflow automatically updates all `MAAS_REF="v3.0.1"` references in documentation and scripts
