...
```bash
export MAAS_REF="v1.0.5"  # Use the latest release tag, or "main" for development
...
!!! note "Using Release Tags"
    ...
    The release workflow automatically updates all `MAAS_REF="v1.0.5"` references in documentation and scripts
